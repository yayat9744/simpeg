...
<!-- DataTables -->
<script src="<?= base_url(); ?>aset/plugins/datatables/jquery.dataTables.js"></script>
<script src="<?= base_url(); ?>aset/plugins/datatables-bs4/js/dataTables.bootstrap4.js"></script>
